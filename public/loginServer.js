...
function gotProfile(accessToken, refreshToken, profile, done) {
    ...
    let count = dbUser.get('SELECT COUNT(*) FROM Users WHERE GoogleID=@0', profile.id);
    if (count === 0) {
...
window.onload = function () {
    ...
    const googleLoginData = {
        clientID: '1042474824241-au9t9eps8sos06j6s8dc84revlli34m1.apps.googleusercontent.com',
        clientSecret: '_f9Zz043sZH93kUynBqVU0o4',
