...
(function () {
    var m = this || self, aa = function (a, b, c) {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var t = window, v = document, ia = t.location, ja = function () {
    }, ka = /\[native code\]/, w = function (a, b, c) {
        return a[b] = a[b] || c
    }, la = function (a) {
    ...
    var D = function (a, b, c) {
        ...
        ya = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"), za = /%([a-f]|[0-9a-fA-F][a-f])/g, Aa = /^(https?|ftp|file|chrome-extension):$/i, F = function (a) {
            a = String(a);
            ...
            var c = [];
            if (a) for (var d in a) if (z(a, d) && null != a[d]) {
                var e = b ? b(a[d]) : a[d];
    ...
    var Ua = w(G, "perf", x()), Va = w(Ua, "g", x()), Wa = w(Ua, "i", x());
    w(Ua, "r", []);
    x();
    x();
    ...
    var $a = x(), J = [], L = function (a) {
        throw Error("Bad hint" + (a ? ": " + a : ""));
    };
    J.push(["jsl", function (a) {
        for (var b in a) if (z(a, b)) {
            var c = a[b];
            "object" == typeof c ? G[b] = w(G, b, []).concat(c) : w(G, b, c)
        }
        if (b = a.u) a = w(G, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var ab = /^(\/[a-zA-Z0-9_\-]+)+$/, bb = [/\/amp\//, /\/amp$/, /^\/amp$/], cb = /^[a-zA-Z0-9\-_\.,!]+$/,
        db = /^gapi\.loaded_[0-9]+$/, eb = /^[a-zA-Z0-9,._-]+$/, ib = function (a, b, c, d) {
            var e = a.split(";"), f = e.shift(), g = $a[f], h = null;
            ...
            for (var b = a.substring(1).split("/"), c = []; b.length;) {
                a = b.shift();
                if (!a.length || 0 == a.indexOf(".")) L("empty/relative directory"); else if (0 < a.indexOf("=")) {
                    b.unshift(a);
                    break
                }
                c.push(a)
        ...
        mb = function (a, b, c) {
            ...
            return null
        }, hb = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, gb = /\/cb=/g,
        fb = /\/\//g, nb = function () {
            var a = Pa(ia.href);
    ...
    var ob = decodeURI("%73cript"), pb = /^[-+_0-9\/A-Za-z]+={0,2}$/, qb = function (a, b) {
        ...
        if ("loading" != v.readyState) sb(a); else {
            var b = rb(), c = "";
            null !== b && (c = ' nonce="' +
                b + '"');
        ...
        h = w(Ta(c), "r", []).sort();
        var p = w(Ta(c), "L", []).sort(), r = [].concat(h), u = function (K, Y) {
            if (n) return 0;
            t.clearTimeout(l);
            p.push.apply(p, y);
    ...
    var yb = function (a) {
        ...
        if (b && "object" === typeof b) for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Ab(a[d]) && !Ab(b[d]) ? N(a[d], b[d]) : b[d] && "object" ===
        ...
        zb(!0);
        var b = window.___gcfg, c = yb("cu"), d = window.___gu;
    ...
    var Lb = window.console, Mb = function (a) {
        Lb && Lb.log && Lb.log(a)
    };
    var Nb = function () {
        return !!G.oa
    ...
    var Sb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        Tb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//, Ub = function (a) {
    ...
    var Wb, Q, R = void 0, S = function (a) {
            try {
        ...
        }, Xb = T(0), Yb = T(new Date(0)), Zb = T(!0), $b = T(""), ac = T({}), bc = T([]), U = function (a, b) {
            ...
            if ("undefined" !== d) {
                ...
                if (null == a) b[b.length] = "null"; else if (e === Xb) a = Number(a), isNaN(a) || isNaN(a - a) ? a = "null" : -0 === a && 0 > 1 / a && (a = "-0"), b[b.length] = String(a); else if (e === Zb) b[b.length] = String(!!Number(a)); else {
        ...
        }, cc = /[\0-\x07\x0b\x0e-\x1f]/, dc = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/,
        ec = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/,
        fc = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/,
        gc = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g,
        hc = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g, ic = /[ \t\n\r]+/g,
        jc = /[^"]:/, kc = /""/g, lc = /true|false|null/g, mc = /00/, nc = /[\{]([^0\}]|0[^:])/,
        oc = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/, pc = /[^\[,:][\[\{]/, qc = /^(\{|\}|\[|\]|,|:|0)+/, rc = /\u2028/g,
        sc = /\u2029/g, tc = function (a) {
            a = String(a);
    ...
    Ac.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (var c = b - this.l, d = 0, e = this.G, f = this.v; d < b;) {
                if (0 == f) for (; d <= c;) Bc(this, a, d), d += this.l;
    ...
    var Dc = t.crypto, Ec = !1, Fc = 0, Gc = 0, Hc = 1, Ic = 0, Jc = "", Kc = function (a) {
        a = a || t.event;
    ...
    var Sc = {
        ...
        vspace: "0",
        width: "100%"
    }, Tc = {allowtransparency: !0, onload: !0}, Uc = 0, Vc = function (a) {
        B(!a || Ga.test(a), "Illegal url for new iframe - " + a)
    }, Wc = function (a, b, c, d, e) {
        Vc(c.src);
        var f, g = Pc(d, c), h = g ? Qc(d) : "";
        try {
    ...
    var Xc = /^:[\w]+$/, Yc = /:([a-zA-Z_]+):/g, Zc = function () {
        var a = Ub() || "0", b = Vb();
        var c = Ub(void 0) || a;
        var d = Vb(void 0), e = "";
    ...
    var dd = {se: "0"}, ed = {post: !0},
        ...
        hd = w(G, "WI", x()), id = function (a, b, c) {
            ...
            c._methods = n.join(",");
            return Da(e, f, c)
        }, jd = ["style", "data-gapiscan"], ld = function (a) {
    ...
    var vd = function (a, b) {
        ...
        if (wd(rd || {})) for (var y in c) {
            ...
            d = [];
            for (y in c) for (a = c[y], u = 0, b = a.length; u < b; u++) e = a[u], yd(y, e, ld(e), d, b);
            zd(r, d)
        }
    }, Ad = function (a) {
        var b = w(C, a, {});
    ...
    var xd = function (a, b) {
        ...
        b && c ? (c(b), (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : C.load(a, function () {
            var d = Ra(a), e = b && b.iframeNode, f = b && b.userParams;
    ...
    var Id = /^\{h:'/, Jd = /^!_/, Kd = "", Fd = function (a, b) {
        ...
        if (d.s && a && -1 != la.call(b, a)) {
            if ("_renderstart" === d.s || d.s === Kd + "/" + a + "::_renderstart") if (d = d.a && d.a[c ? 0 : 1], b = v.getElementById(a), Qb(a, 2), d && b && d.width && d.height) {
                a:{
                    c = b.parentNode;
                    a = d || {};
                    if (Nb()) {
    ...
    var Rd = "https:" === window.location.protocol, Sd = Rd || "http:" === window.location.protocol ? Nd : Qd,
        Td = function (a) {
    ...
    var Zd = function () {
        var a = Yd(), b = a && a.ea || null, c = a && a.clientId;
        M("auth", {
            callback: function () {
                var d = t.gapi.auth, e = {client_id: c, session_state: b};
                d.checkSessionState(e, function (f) {
                    var g = e.session_state, h = O("isLoggedIn");
...
gapi.load("", {
    callback: window["renderButton"], _c: {
        "jsl": {
            "ci": {
                "deviceType": "desktop",
                "oauth-flow": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.zh_CN.tjVnuyQKJi4.O/am\u003dwQE/d\u003d1/rs\u003dAGLTcCMXEwgygAL65lQ3YSTxm4LcayqsDg/m\u003d__features__",
